<template>
    <nav class="flex justify-between w-full px-4 sm:px-10 lg:px-16 py-5 top-0 fixed bg-[#030a09] z-50" data-aos="flip-up" data-aos-easing="ease-in-quart" data-aos-duration="700">
        ...
        <div class="absolute left-0 w-0 opacity-0 bg-[#030a09] h-screen z-50 py-7 px-8 ease-linear" :class="showSidebar ? '!w-64 !opacity-100 duration-300' : 'duration-500 delay-200'">
